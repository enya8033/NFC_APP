...
public class MainActivity extends AppCompatActivity {
    /**
     * The messages to be shown depending on the event that occurred
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivateTagButton = findViewById(R.id.ActivateTagButton);
        context = this;
        ActivateTagButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                try {
                    if (myTag == null) {
                        ...
                        write("PlainText" + userInputText.getText().toString(), myTag);
        ...
        /**
         * In a case where an android phone that does not support NFC capabilities
         */
    ...
    private void buildTagViews(NdefMessage[] messages) {
        ...
        String textEncoding = ((payload[0] & 120) == 0) ? "UTF-8" : "UTF-16";
